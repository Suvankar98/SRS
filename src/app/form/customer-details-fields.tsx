      ...
      <div className="md:col-span-2">
        <div className="grid gap-4 rounded-2xl bg-slate-50 p-4 sm:gap-5 md:grid-cols-2">
          ...
          <div className="grid gap-2 sm:grid-cols-[minmax(0,1fr)_3rem] sm:items-end">
            <Field label="Ph No. - Contact 1" name="phoneNumber1" value={phoneNumber1} onChange={setPhoneNumber1} placeholder="+91 9876543210" type="tel" />
            <button
              type="button"
          ...
          {showSecondContact ? (
            <>
              ...
              <Field label="Ph No. - Contact 2" name="phoneNumber2" value={phoneNumber2} onChange={setPhoneNumber2} placeholder="+91 9876543210" type="tel" required={false} />
            </>
          ) : null}
        </div>
      </div>
