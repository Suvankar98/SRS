...
const COUNTRY_CODES = [
  { code: "+1", label: "United States / Canada / Caribbean" },
  ...
  { code: "+39", label: "Italy / Vatican City" },
  ...
  { code: "+47", label: "Norway / Svalbard / Jan Mayen" },
  ...
  { code: "+61", label: "Australia / Christmas Island / Cocos Islands" },
  { code: "+62", label: "Indonesia" },
  { code: "+63", label: "Philippines" },
  { code: "+64", label: "New Zealand / Pitcairn" },
  ...
  { code: "+672", label: "Norfolk Island / Antarctica" },
